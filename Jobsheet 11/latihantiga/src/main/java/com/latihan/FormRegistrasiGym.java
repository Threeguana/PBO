package latihantiga.src.main.java.com.latihan;
        ...
        btnSimpan.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (nama.isEmpty() || usiaStr.isEmpty()) {
                    JOptionPane.showMessageDialog(frame, "Nama dan usia wajib diisi!", "Error",
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(frame, "Usia harus berupa angka!", "Error",
                            JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                try {
                    ...
                    Connection conn = DriverManager
                            .getConnection("jdbc:mysql://localhost:3306/db_gym", "root", "" // isi
                                                                                            // password
                                                                                            // jika
                                                                                            // ada
                    );
                    ...
                    JOptionPane.showMessageDialog(frame, "Member gym berhasil didaftarkan!",
